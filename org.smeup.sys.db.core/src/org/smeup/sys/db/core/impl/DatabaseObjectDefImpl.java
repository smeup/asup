 ...
 * <ul>
 *   <li>{@link org.smeup.sys.db.core.impl.DatabaseObjectDefImpl#getLabel <em>Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DatabaseObjectDefImpl extends MinimalEObjectImpl.Container implements QDatabaseObjectDef {
	...
	public void setLabel(String newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDatabaseCorePackage.DATABASE_OBJECT_DEF__LABEL, oldLabel, label));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QDatabaseCorePackage.DATABASE_OBJECT_DEF__LABEL:
				return getLabel();
		}

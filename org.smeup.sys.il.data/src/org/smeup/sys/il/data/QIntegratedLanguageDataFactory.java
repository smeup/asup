...
public interface QIntegratedLanguageDataFactory extends EFactory {
	 ...
	 * @generated
	 */
	QIntegratedLanguageDataFactory eINSTANCE = org.smeup.sys.il.data.impl.IntegratedLanguageDataFactoryImpl
			.init();

	/**
	 * Returns a new object of class '<em>Data Reader</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 *
	...
	/**
	 * Returns a new object of class '<em>Data Writer</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 *

 ...
 * @generated
 */
public class TermFactoryImpl extends EFactoryImpl implements QTermFactory {
	/**
	 ...
	 * @generated
	 */
	public static QTermFactory init() {
		try {
			QTermFactory theTermFactory = (QTermFactory)EPackage.Registry.INSTANCE.getEFactory(QTermPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case QTermPackage.FORMAT: return (EObject)createFormat();
			case QTermPackage.OVERLAY: return (EObject)createOverlay();
			case QTermPackage.RANGE: return (EObject)createRange();
			case QTermPackage.REMAP: return (EObject)createRemap();
			case QTermPackage.SPECIAL: return (EObject)createSpecial();
			case QTermPackage.SPECIAL_ELEMENT: return (EObject)createSpecialElement();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case QTermPackage.DATA_TERM_TYPE:
				return createDataTermTypeFromString(eDataType, initialValue);
			case QTermPackage.FORMAT_TYPE:
	 ...
	 * @generated
	 */
	public QTermPackage getTermPackage() {
		return (QTermPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static QTermPackage getPackage() {
		return QTermPackage.eINSTANCE;
	}

...
public enum DataTermType implements Enumerator {
	...
	/**
	 * The '<em><b>Unary Atomic</b></em>' literal value. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * The '<em><b>Unary Compound</b></em>' literal value. <!-- begin-user-doc
	 * -->
	 * <p>
	...
	/**
	 * The '<em><b>Multiple Atomic</b></em>' literal value. <!-- begin-user-doc
	 * -->
	 * <p>
	...
	public static DataTermType get(int value) {
		switch (value) {
		case UNARY_ATOMIC_VALUE:
			return UNARY_ATOMIC;
		case UNARY_COMPOUND_VALUE:
			return UNARY_COMPOUND;
		case MULTIPLE_ATOMIC_VALUE:
			return MULTIPLE_ATOMIC;
		case MULTIPLE_COMPOUND_VALUE:

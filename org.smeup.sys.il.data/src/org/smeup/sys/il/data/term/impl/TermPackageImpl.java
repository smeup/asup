...
import org.smeup.sys.il.data.term.QTermFactory;
 ...
 * @generated
 */
public class TermPackageImpl extends EPackageImpl implements QTermPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.smeup.sys.il.data.term.QTermPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TermPackageImpl() {
		super(eNS_URI, QTermFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link QTermPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static QTermPackage init() {
		if (isInited) return (QTermPackage)EPackage.Registry.INSTANCE.getEPackage(QTermPackage.eNS_URI);
		...
		EPackage.Registry.INSTANCE.put(QTermPackage.eNS_URI, theTermPackage);
	 ...
	 * @generated
	 */
	public QTermFactory getTermFactory() {
		return (QTermFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		EGenericType g1 = createEGenericType(theDefPackage.getDataDef());

 ...
 *   <li>{@link org.smeup.sys.il.data.def.impl.MultipleCompoundDataDefImpl#isInitialized <em>Initialized</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MultipleCompoundDataDefImpl<D extends QStroller<?>, E extends QDataTerm<?>> extends MultipleDataDefImpl<D> implements QMultipleCompoundDataDef<D, E> {
	...
	protected EClass eStaticClass() {
		return QDefPackage.Literals.MULTIPLE_COMPOUND_DATA_DEF;
	}
	...
	public void setClassDelegator(String newClassDelegator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__CLASS_DELEGATOR, oldClassDelegator, classDelegator));
	}
	...
	public List<E> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<E>(QDataTerm.class, this, QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__ELEMENTS);
		}
		return elements;
	}
	...
	public void setPrefix(String newPrefix) {
		...
		prefix = newPrefix;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__PREFIX, oldPrefix, prefix));
	}
	...
	public void setQualified(boolean newQualified) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__QUALIFIED, oldQualified, qualified));
	}
	...
	public void setInitialized(boolean newInitialized) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__INITIALIZED, oldInitialized, initialized));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__ELEMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__CLASS_DELEGATOR:
				return getClassDelegator();
			case QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__ELEMENTS:
				return getElements();
			case QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__PREFIX:
				return getPrefix();
			case QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__QUALIFIED:
				return isQualified();
			case QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__INITIALIZED:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == QCompoundDataDef.class) {
			switch (derivedFeatureID) {
				case QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__CLASS_DELEGATOR: return QDefPackage.COMPOUND_DATA_DEF__CLASS_DELEGATOR;
				case QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__ELEMENTS: return QDefPackage.COMPOUND_DATA_DEF__ELEMENTS;
				case QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__PREFIX: return QDefPackage.COMPOUND_DATA_DEF__PREFIX;
				case QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__QUALIFIED: return QDefPackage.COMPOUND_DATA_DEF__QUALIFIED;
				case QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__INITIALIZED: return QDefPackage.COMPOUND_DATA_DEF__INITIALIZED;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == QCompoundDataDef.class) {
			switch (baseFeatureID) {
				case QDefPackage.COMPOUND_DATA_DEF__CLASS_DELEGATOR: return QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__CLASS_DELEGATOR;
				case QDefPackage.COMPOUND_DATA_DEF__ELEMENTS: return QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__ELEMENTS;
				case QDefPackage.COMPOUND_DATA_DEF__PREFIX: return QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__PREFIX;
				case QDefPackage.COMPOUND_DATA_DEF__QUALIFIED: return QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__QUALIFIED;
				case QDefPackage.COMPOUND_DATA_DEF__INITIALIZED: return QDefPackage.MULTIPLE_COMPOUND_DATA_DEF__INITIALIZED;
				default: return -1;
			}
		}

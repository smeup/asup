 ...
 * @generated
 */
public abstract class CompoundDataDefImpl<D extends QStruct<?>, E extends QDataTerm<?>> extends DataDefImpl<D> implements QCompoundDataDef<D, E> {
	/**
	 *
	 */
	...
	protected EClass eStaticClass() {
		return QDefPackage.Literals.COMPOUND_DATA_DEF;
	}
	...
	public void setClassDelegator(String newClassDelegator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDefPackage.COMPOUND_DATA_DEF__CLASS_DELEGATOR, oldClassDelegator, classDelegator));
	}
	...
	public List<E> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<E>(QDataTerm.class, this, QDefPackage.COMPOUND_DATA_DEF__ELEMENTS);
		}
		return elements;
	}
	...
	public void setPrefix(String newPrefix) {
		...
		prefix = newPrefix;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDefPackage.COMPOUND_DATA_DEF__PREFIX, oldPrefix, prefix));
	}
	...
	public void setQualified(boolean newQualified) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDefPackage.COMPOUND_DATA_DEF__QUALIFIED, oldQualified, qualified));
	}
	...
	public void setInitialized(boolean newInitialized) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDefPackage.COMPOUND_DATA_DEF__INITIALIZED, oldInitialized, initialized));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QDefPackage.COMPOUND_DATA_DEF__ELEMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QDefPackage.COMPOUND_DATA_DEF__CLASS_DELEGATOR:
				return getClassDelegator();
			case QDefPackage.COMPOUND_DATA_DEF__ELEMENTS:
				return getElements();
			case QDefPackage.COMPOUND_DATA_DEF__PREFIX:
				return getPrefix();
			case QDefPackage.COMPOUND_DATA_DEF__QUALIFIED:
				return isQualified();
			case QDefPackage.COMPOUND_DATA_DEF__INITIALIZED:

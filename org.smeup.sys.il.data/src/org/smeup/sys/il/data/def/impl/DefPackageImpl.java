...
import org.smeup.sys.il.data.def.QDefFactory;
 ...
 * @generated
 */
public class DefPackageImpl extends EPackageImpl implements QDefPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.smeup.sys.il.data.def.QDefPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DefPackageImpl() {
		super(eNS_URI, QDefFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link QDefPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static QDefPackage init() {
		if (isInited) return (QDefPackage)EPackage.Registry.INSTANCE.getEPackage(QDefPackage.eNS_URI);
		...
		EPackage.Registry.INSTANCE.put(QDefPackage.eNS_URI, theDefPackage);
	 ...
	 * @generated
	 */
	public QDefFactory getDefFactory() {
		return (QDefFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		g1.getETypeArguments().add(g2);
		g2 = createEGenericType(theTermPackage.getDataTerm());
		g1.getETypeArguments().add(g2);

 ...
 * @generated
 */
public class DefFactoryImpl extends EFactoryImpl implements QDefFactory {
	/**
	 ...
	 * @generated
	 */
	public static QDefFactory init() {
		try {
			QDefFactory theDefFactory = (QDefFactory)EPackage.Registry.INSTANCE.getEFactory(QDefPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case QDefPackage.ADAPTER_DEF: return (EObject)createAdapterDef();
			case QDefPackage.ARRAY_DEF: return (EObject)createArrayDef();
			case QDefPackage.BINARY_DEF: return (EObject)createBinaryDef();
			case QDefPackage.BUFFER_DEF: return (EObject)createBufferDef();
			case QDefPackage.CHARACTER_DEF: return (EObject)createCharacterDef();
			case QDefPackage.DATA_AREA_DEF: return (EObject)createDataAreaDef();
			case QDefPackage.DATA_STRUCT_DEF: return (EObject)createDataStructDef();
			case QDefPackage.DATETIME_DEF: return (EObject)createDatetimeDef();
			case QDefPackage.DECIMAL_DEF: return (EObject)createDecimalDef();
			case QDefPackage.FLOATING_DEF: return (EObject)createFloatingDef();
			case QDefPackage.GRAPHIC_DEF: return (EObject)createGraphicDef();
			case QDefPackage.HEXADECIMAL_DEF: return (EObject)createHexadecimalDef();
			case QDefPackage.IDENTITY_DEF: return (EObject)createIdentityDef();
			case QDefPackage.INDICATOR_DEF: return (EObject)createIndicatorDef();
			case QDefPackage.LIST_DEF: return (EObject)createListDef();
			case QDefPackage.NUMERIC_DEF: return (EObject)createNumericDef();
			case QDefPackage.POINTER_DEF: return (EObject)createPointerDef();
			case QDefPackage.SCROLLER_DEF: return (EObject)createScrollerDef();
			case QDefPackage.STRING_DEF: return (EObject)createStringDef();
			case QDefPackage.STROLLER_DEF: return (EObject)createStrollerDef();
			default:
	 ...
	 * @generated
	 */
	public QDefPackage getDefPackage() {
		return (QDefPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static QDefPackage getPackage() {
		return QDefPackage.eINSTANCE;
	}

...
public class DomainImpl extends FacetImpl implements QDomain {
	...
	protected EClass eStaticClass() {
		return QIntegratedLanguageCoreMetaPackage.Literals.DOMAIN;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageCoreMetaPackage.DOMAIN__NAME, oldName, name));
	}
	...
	public void setText(String newText) {
		...
		text = newText;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageCoreMetaPackage.DOMAIN__TEXT, oldText, text));
	}

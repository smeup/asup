...
public class DevelopmentKitCompilerPackageImpl extends EPackageImpl implements QDevelopmentKitCompilerPackage {
	...
	public void initializePackageContents() {
		...
		compilationUnitEClass.getESuperTypes().add(theMachineInterfaceCorePackage.getJavaCloseable());
		...
		op = addEOperation(compilationUnitEClass, null, "getDataTerms", 1, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEBoolean(), "deep", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		g2 = createEGenericType();
		g1.getETypeArguments().add(g2);
		g3 = createEGenericType(theIntegratedLanguageDataPackage.getData());
		...
		op = addEOperation(compilationUnitEClass, ecorePackage.getEString(), "normalizeLabelName", 1, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "name", 1, 1, IS_UNIQUE, IS_ORDERED);

// $ANTLR 3.5.1 C:\\Users\\darfores\\git\\asup_0_8_0\\org.smeup.sys.db.syntax.ibmi\\src\\org\\smeup\\sys\\db\\syntax\\ibmi\\parser\\ddl\\DDL.g 2016-06-15 15:35:18
...
public class DDLParser extends Parser {
		...
		try {
			...
			switch (alt54) {
				case 1 :
					...
					// AST REWRITE
					// elements: t, USING, LOCATION, EXTERNAL, def, p, path, f
					// token labels: path, f
	...
	public final DDLParser.field_element_return field_element() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: Identifier, c, with_default, field_type, not_null
			// token labels: c
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
			...
			switch (alt64) {
				case 1 :
					...
					// 646:71: -> ^( CONNECT_STATEMENT ( ^( TO $s) ^( USER $u) ^( USING $p) )? )
					{
						...
						if ( stream_USER.hasNext()||stream_USING.hasNext()||stream_u.hasNext()||stream_TO.hasNext()||stream_s.hasNext()||stream_p.hasNext() ) {
	...
	public final DDLParser.insert_statement_return insert_statement() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: INSERT, table, array, column_reference_list
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final DDLParser.query_specification_return query_specification() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: from_clause, where_clause, SELECT, groupby_clause, limit_clause, set_qualifier, select_list, having_clause, orderby_clause
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 

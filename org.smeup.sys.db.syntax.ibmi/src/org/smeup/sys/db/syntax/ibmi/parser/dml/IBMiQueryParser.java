...
class IBMiQueryParser extends org.eclipse.datatools.sqltools.parsers.sql.query.AbstractSQLQueryParser // SQLParser
{
	 ...
	 * @param checkStmtOnly
	 */
	IBMiQueryParser(LexStream lexStream, IBMiQueryParserFactory factory, SQLQuerySourceFormat sourceFormat, boolean checkStmtOnly) throws SQLParserInternalException {
		super(lexStream, new IBMiQueryParserprs(), IBMiQueryParserprs.EOFT_SYMBOL, sourceFormat, checkStmtOnly);
		this.m_factory = factory;
	}

	IBMiQueryParser(LexStream lexStream, IBMiQueryParserFactory factory, SQLQuerySourceFormat sourceFormat) throws SQLParserInternalException {
		this(lexStream, factory, sourceFormat, false);
	}

	IBMiQueryParser(LexStream lexStream, IBMiQueryParserFactory factory) throws SQLParserInternalException {
		this(lexStream, factory, SQLQuerySourceFormat.copyDefaultFormat());
	}

	IBMiQueryParser(LexStream lexStream, IBMiQueryParserFactory factory, boolean checkStmtOnly) throws SQLParserInternalException {
		this(lexStream, factory, SQLQuerySourceFormat.copyDefaultFormat(), checkStmtOnly);
	}

	IBMiQueryParser(LexStream lexStream) throws SQLParserInternalException {
		this(lexStream, new IBMiQueryParserFactory());
	}

	IBMiQueryParser(LexStream lexStream, boolean checkStmtOnly) throws SQLParserInternalException {
		this(lexStream, new IBMiQueryParserFactory(), checkStmtOnly);
	}

	@Override
	public String[] orderedTerminalSymbols() {
		return IBMiQueryParsersym.orderedTerminalSymbols;
	}

	protected double getTokenDbl(int p_tok) {
		int tok = p_tok;
		int tokKind = getKind(p_tok);
		if (tokKind == IBMiQueryParsersym.TK_MINUS_SIGN) {
			++tok;
			return -1 * Double.parseDouble(getTokenName(tok));
		} else if (tokKind == IBMiQueryParsersym.TK_PLUS_SIGN)
			++tok;
	...
	public void ruleAction(int ruleNumber) {
		...
		/*
		 * Rule 2: <sql_dml_stmt_list> ::= <sql_dml_stmt_list> _STMT_TERM
		 * <sql_dml_stmt_xspan>
		 */
		case 2: {
		...
		case 4: {
			...
			if (hasComments())
				extendSpanToFollowingToken((QueryStatement) getSym(1), IBMiQueryParsersym.TK_STATEMENT_TERMINATOR);
		...
		/*
		 * Rule 15: <all_or_any_cond> ::= _LPAREN
		 * <expression_commalist_multiple_elements> _RPAREN _EQ ANY <subquery>
		 */
		case 15: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 16: <all_or_any_cond> ::= _LPAREN
		 * <expression_commalist_multiple_elements> _RPAREN _EQ SOME <subquery>
		 */
		case 16: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		case 19: {
			...
			break;
		/*
		 * Rule 20: <argument_list_body> ::= <argument_list_body> _COMMA
		 * <argument>
		 */
		case 20: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 25: <boolean_expression> ::= <boolean_expression> OR
		 * <boolean_term>
		 */
		case 25: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 30: <boolean_factor> ::= <boolean_primary> IS NOT
		 * <boolean_values>
		 */
		case 30: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 36: <boolean_primary> ::= NOT _LPAREN <boolean_expression>
		 * _RPAREN
		 */
		case 36: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 37: <call_statement> ::= CALL <procedure_object>
		 * <opt_argument_list>
		 */
		case 37: {
			if (checkStmtOnly) {
			...
			break;
		/*
		 * Rule 38: <case_expression> ::= CASE <case_search_when_list>
		 * <opt_case_else> END
		 */
		case 38: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 39: <case_expression> ::= CASE <expression>
		 * <case_simple_when_list> <opt_case_else> END
		 */
		case 39: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 42: <case_search_when_list> ::= <case_search_when_list>
		 * <case_search_when>
		 */
		case 42: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 45: <case_simple_when_list> ::= <case_simple_when_list>
		 * <case_simple_when>
		 */
		case 45: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 46: <cast_expression> ::= CAST _LPAREN <cast_operand> AS
		 * <cast_target> _RPAREN
		 */
		case 46: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 53: <column_name_list> ::= <column_name_list> _COMMA
		 * <column_name>
		 */
		case 53: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 72: <datatype_array_type> ::= <datatype> ARRAY
		 * <left_bracket_or_trigraph> _INTNUMBER <right_bracket_or_trigraph>
		 */
		case 72: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		case 81: {
			...
			setSym1(m_factory.createDataTypeTime(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_TIME, 0, DataTypeHelper.TYPENAME_TIME));
		}
			break;
		...
		case 82: {
			...
			setSym1(m_factory.createDataTypeTime(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_TIMESTAMP, 0, DataTypeHelper.TYPENAME_TIMESTAMP));
		}
			break;
		...
		case 87: {
			...
			setSym1(m_factory.createDataTypeNumericApproximate(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_FLOAT, 0, DataTypeHelper.TYPENAME_FLOAT));
		}
			break;

		/*
		 * Rule 88: <datatype_numerical_approximate> ::= FLOAT _LPAREN
		 * _INTNUMBER _RPAREN
		 */
		case 88: {
			if (checkStmtOnly) {
			...
			setSym1(m_factory.createDataTypeNumericApproximate(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_FLOAT, Integer.parseInt(getTokenName(3)), DataTypeHelper.TYPENAME_FLOAT));
		}
			break;
		...
		case 89: {
			...
			setSym1(m_factory.createDataTypeNumericApproximate(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_REAL, 0, DataTypeHelper.TYPENAME_REAL));
		}
			break;
		...
		case 90: {
			...
			setSym1(m_factory.createDataTypeNumericApproximate(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_DOUBLE_PRECISION, 0, DataTypeHelper.TYPENAME_DOUBLE));
		}
			break;
		...
		case 91: {
			...
			setSym1(m_factory.createDataTypeNumericApproximate(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_DOUBLE_PRECISION, 0, DataTypeHelper.TYPENAME_DOUBLE_PRECISION));
		}
			break;
		...
		case 92: {
			...
			setSym1(m_factory.createDataTypeNumericFixedPrecision(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_NUMERIC, 0, 0, DataTypeHelper.TYPENAME_NUMERIC));
		}
			break;
		...
		case 93: {
			...
			setSym1(m_factory.createDataTypeNumericFixedPrecision(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_DECIMAL, 0, 0, DataTypeHelper.TYPENAME_DECIMAL));
		}
			break;
		...
		case 94: {
			...
			setSym1(m_factory.createDataTypeNumericFixedPrecision(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_DECIMAL, 0, 0, DataTypeHelper.TYPENAME_DEC));
		}
			break;

		/*
		 * Rule 95: <datatype_numerical_fixed_precision> ::= NUMERIC _LPAREN
		 * _INTNUMBER _RPAREN
		 */
		case 95: {
			if (checkStmtOnly) {
			...
			setSym1(m_factory.createDataTypeNumericFixedPrecision(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_NUMERIC, Integer.parseInt(getTokenName(3)), 0, DataTypeHelper.TYPENAME_NUMERIC));
		}
			break;

		/*
		 * Rule 96: <datatype_numerical_fixed_precision> ::= DECIMAL _LPAREN
		 * _INTNUMBER _RPAREN
		 */
		case 96: {
			if (checkStmtOnly) {
			...
			setSym1(m_factory.createDataTypeNumericFixedPrecision(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_DECIMAL, Integer.parseInt(getTokenName(3)), 0, DataTypeHelper.TYPENAME_DECIMAL));
		}
			break;

		/*
		 * Rule 97: <datatype_numerical_fixed_precision> ::= DEC _LPAREN
		 * _INTNUMBER _RPAREN
		 */
		case 97: {
			if (checkStmtOnly) {
			...
			setSym1(m_factory.createDataTypeNumericFixedPrecision(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_DECIMAL, Integer.parseInt(getTokenName(3)), 0, DataTypeHelper.TYPENAME_DEC));
		}
			break;

		/*
		 * Rule 98: <datatype_numerical_fixed_precision> ::= NUMERIC _LPAREN
		 * _INTNUMBER _COMMA _INTNUMBER _RPAREN
		 */
		case 98: {
			if (checkStmtOnly) {
				setSym1(null);
			...
			setSym1(m_factory.createDataTypeNumericFixedPrecision(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_NUMERIC, Integer.parseInt(getTokenName(3)), Integer.parseInt(getTokenName(5)),
					DataTypeHelper.TYPENAME_NUMERIC));
		}
			break;

		/*
		 * Rule 99: <datatype_numerical_fixed_precision> ::= DECIMAL _LPAREN
		 * _INTNUMBER _COMMA _INTNUMBER _RPAREN
		 */
		case 99: {
			if (checkStmtOnly) {
			...
			setSym1(m_factory.createDataTypeNumericFixedPrecision(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_DECIMAL, Integer.parseInt(getTokenName(3)), Integer.parseInt(getTokenName(5)),
					DataTypeHelper.TYPENAME_DECIMAL));
		}
			break;

		/*
		 * Rule 100: <datatype_numerical_fixed_precision> ::= DEC _LPAREN
		 * _INTNUMBER _COMMA _INTNUMBER _RPAREN
		 */
		case 100: {
			if (checkStmtOnly) {
		...
		case 101: {
			...
			setSym1(m_factory.createDataTypeNumericInteger(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_INTEGER, 0, DataTypeHelper.TYPENAME_INTEGER));
		}
			break;
		...
		case 102: {
			...
			setSym1(m_factory.createDataTypeNumericInteger(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_INTEGER, 0, DataTypeHelper.TYPENAME_INT));
		}
			break;
		...
		case 103: {
			...
			setSym1(m_factory.createDataTypeNumericInteger(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_SMALLINT, 0, DataTypeHelper.TYPENAME_SMALLINT));
		}
			break;
		...
		case 104: {
			...
			setSym1(m_factory.createDataTypeNumericInteger(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_BIGINT, 0, DataTypeHelper.TYPENAME_BIGINT));
		}
			break;
		...
		case 105: {
			...
			setSym1(m_factory.createDataTypeBinaryString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_BINARY_LARGE_OBJECT, 0, null, DataTypeHelper.TYPENAME_BLOB));
		}
			break;

		/*
		 * Rule 106: <datatype_binary> ::= BLOB _LPAREN _INTNUMBER
		 * <datatype_opt_size_unit> _RPAREN
		 */
		case 106: {
			if (checkStmtOnly) {
				setSym1(null);
			...
			setSym1(m_factory.createDataTypeBinaryString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_BINARY_LARGE_OBJECT, Integer.parseInt(getTokenName(3)), getString(4),
					DataTypeHelper.TYPENAME_BLOB));
		}
			break;
		...
		case 107: {
			...
			setSym1(m_factory.createDataTypeBinaryString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_BINARY_LARGE_OBJECT, 0, null, DataTypeHelper.TYPENAME_BINARY_LARGE_OBJECT));
		}
			break;

		/*
		 * Rule 108: <datatype_binary> ::= BINARY LARGE OBJECT _LPAREN
		 * _INTNUMBER <datatype_opt_size_unit> _RPAREN
		 */
		case 108: {
			if (checkStmtOnly) {
				setSym1(null);
			...
			setSym1(m_factory.createDataTypeBinaryString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_BINARY_LARGE_OBJECT, Integer.parseInt(getTokenName(3)), getString(4),
					DataTypeHelper.TYPENAME_BINARY_LARGE_OBJECT));
		}
			break;
		...
		case 109: {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_CHARACTER, 0, null, DataTypeHelper.TYPENAME_CHARACTER));
		}
			break;
		...
		case 110: {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_CHARACTER, 0, null, DataTypeHelper.TYPENAME_CHAR));
		}
			break;

		/*
		 * Rule 111: <datatype_character> ::= CHARACTER _LPAREN _INTNUMBER
		 * _RPAREN
		 */
		case 111: {
			if (checkStmtOnly) {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_CHARACTER, Integer.parseInt(getTokenName(3)), null, DataTypeHelper.TYPENAME_CHARACTER));
		}
			break;
		...
		case 112: {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_CHARACTER, Integer.parseInt(getTokenName(3)), null, DataTypeHelper.TYPENAME_CHAR));
		}
			break;

		/*
		 * Rule 113: <datatype_character> ::= CHARACTER VARYING _LPAREN
		 * _INTNUMBER _RPAREN
		 */
		case 113: {
			if (checkStmtOnly) {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_CHARACTER_VARYING, Integer.parseInt(getTokenName(4)), null,
					DataTypeHelper.TYPENAME_CHARACTER_VARYING));
		}
			break;

		/*
		 * Rule 114: <datatype_character> ::= CHAR VARYING _LPAREN _INTNUMBER
		 * _RPAREN
		 */
		case 114: {
			if (checkStmtOnly) {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_CHARACTER_VARYING, Integer.parseInt(getTokenName(4)), null,
					DataTypeHelper.TYPENAME_CHAR_VARYING));
		}
			break;
		...
		case 115: {
			...
			setSym1(m_factory
					.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_CHARACTER_VARYING, Integer.parseInt(getTokenName(3)), null, DataTypeHelper.TYPENAME_VARCHAR));
		}
			break;
		...
		case 116: {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_CHARACTER_LARGE_OBJECT, 0, null, DataTypeHelper.TYPENAME_CLOB));
		}
			break;

		/*
		 * Rule 117: <datatype_character> ::= CLOB _LPAREN _INTNUMBER
		 * <datatype_opt_size_unit> _RPAREN
		 */
		case 117: {
			if (checkStmtOnly) {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_CHARACTER_LARGE_OBJECT, Integer.parseInt(getTokenName(3)), getString(4),
					DataTypeHelper.TYPENAME_CLOB));
		}
			break;
		...
		case 118: {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_CHARACTER_LARGE_OBJECT, 0, null, DataTypeHelper.TYPENAME_CHARACTER_LARGE_OBJECT));
		}
			break;

		/*
		 * Rule 119: <datatype_character> ::= CHARACTER LARGE OBJECT _LPAREN
		 * _INTNUMBER <datatype_opt_size_unit> _RPAREN
		 */
		case 119: {
			if (checkStmtOnly) {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_CHARACTER_LARGE_OBJECT, Integer.parseInt(getTokenName(5)), getString(6),
					DataTypeHelper.TYPENAME_CHARACTER_LARGE_OBJECT));
		}
			break;
		...
		case 120: {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_CHARACTER_LARGE_OBJECT, 0, null, DataTypeHelper.TYPENAME_CHAR_LARGE_OBJECT));
		}
			break;

		/*
		 * Rule 121: <datatype_character> ::= CHAR LARGE OBJECT _LPAREN
		 * _INTNUMBER <datatype_opt_size_unit> _RPAREN
		 */
		case 121: {
			if (checkStmtOnly) {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_CHARACTER_LARGE_OBJECT, Integer.parseInt(getTokenName(5)), getString(6),
					DataTypeHelper.TYPENAME_CHAR_LARGE_OBJECT));
		}
			break;
		...
		case 122: {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_NATIONAL_CHARACTER, 0, null, DataTypeHelper.TYPENAME_GRAPHIC));
		}
			break;

		/*
		 * Rule 123: <datatype_character_national> ::= GRAPHIC _LPAREN
		 * _INTNUMBER _RPAREN
		 */
		case 123: {
			if (checkStmtOnly) {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_NATIONAL_CHARACTER, Integer.parseInt(getTokenName(3)), null,
					DataTypeHelper.TYPENAME_GRAPHIC));
		}
			break;

		/*
		 * Rule 124: <datatype_character_national> ::= VARGRAPHIC _LPAREN
		 * _INTNUMBER _RPAREN
		 */
		case 124: {
			if (checkStmtOnly) {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_NATIONAL_CHARACTER_VARYING, Integer.parseInt(getTokenName(3)), null,
					DataTypeHelper.TYPENAME_VARGRAPHIC));
		}
			break;
		...
		case 125: {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_NATIONAL_CHARACTER_LARGE_OBJECT, 0, null, DataTypeHelper.TYPENAME_DBCLOB));
		}
			break;

		/*
		 * Rule 126: <datatype_character_national> ::= DBCLOB _LPAREN _INTNUMBER
		 * <datatype_opt_size_unit> _RPAREN
		 */
		case 126: {
			if (checkStmtOnly) {
			...
			setSym1(m_factory.createDataTypeCharacterString(SQLQueryParserFactoryDataTypes.PRIMITIVE_TYPE_NATIONAL_CHARACTER_LARGE_OBJECT, Integer.parseInt(getTokenName(3)), getString(4),
					DataTypeHelper.TYPENAME_DBCLOB));
		}
			break;
		...
		/*
		 * Rule 131: <datatype_path-resolved_user-defined_type_name> ::=
		...
		/*
		 * Rule 140: <delete_stmt> ::= DELETE FROM <target_table>
		 * <opt_as_target_table> <opt_where_clause>
		 */
		case 140: {
		...
		/*
		 * Rule 142: <derived_column_list> ::= <target_column_list> _COMMA
		 * <column_ref>
		 */
		case 142: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 155: <expression_commalist> ::= <expression_commalist> _COMMA
		 * <expression>
		 */
		case 155: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 157: <expression_commalist_multiple_elements> ::=
		...
		/*
		 * Rule 171: <expression_term> ::= <expression_term> _STAR
		 * <expression_factor>
		 */
		case 171: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 172: <expression_term> ::= <expression_term> _SLASH
		 * <expression_factor>
		 */
		case 172: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 173: <expression_term> ::= <expression_term> CONCAT
		 * <expression_factor>
		 */
		case 173: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 174: <expression_term> ::= <expression_term> _CONCAT_OPERATOR
		 * <expression_factor>
		 */
		case 174: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 178: <fetch_first_clause> ::= FETCH FIRST
		 * <opt_fetch_first_row_count> <row_or_rows> ONLY
		 */
		case 178: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		case 180: {
			...
			break;
		/*
		 * Rule 181: <function> ::= <opt_schema_dot> <identifier> _LPAREN _STAR
		 * _RPAREN
		 */
		case 181: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 182: <function> ::= <opt_schema_dot> <identifier> _LPAREN
		 * <opt_all_distinct> <opt_expression_commalist> _RPAREN
		 */
		case 182: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 186: <grouping_sets> ::= GROUPING SETS _LPAREN
		 * <grouping_sets_element_list> _RPAREN
		 */
		case 186: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 188: <grouping_sets_element_list> ::=
		...
		/*
		 * Rule 189: <grouping_sets_element> ::= _LPAREN
		 * <grouping_sets_element_exp_list> _RPAREN
		 */
		case 189: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 192: <grouping_sets_element_exp_list> ::=
		...
		/*
		 * Rule 193: <grouping_sets_element_exp_list> ::=
		...
		/*
		 * Rule 197: <grouping_spec_list> ::= <grouping_spec_list> _COMMA
		 * <grouping_spec>
		 */
		case 197: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 201: <in_cond> ::= <expression> NOT IN _LPAREN
		 * <expression_commalist> _RPAREN
		 */
		case 201: {
			if (checkStmtOnly) {
				setSym1(null);
			...
			break;
		/*
		 * Rule 202: <in_cond> ::= <expression> IN _LPAREN
		 * <expression_commalist> _RPAREN
		 */
		case 202: {
			if (checkStmtOnly) {
		...
		case 204: {
			...
			break;
		/*
		 * Rule 205: <in_cond> ::= _LPAREN <expression_commalist> _COMMA
		 * <expression> _RPAREN NOT IN <subquery>
		 */
		case 205: {
			if (checkStmtOnly) {
				setSym1(null);
			...
			break;
		/*
		 * Rule 206: <in_cond> ::= _LPAREN <expression_commalist> _COMMA
		 * <expression> _RPAREN IN <subquery>
		 */
		case 206: {
			if (checkStmtOnly) {
				setSym1(null);
			...
			break;
		/*
		 * Rule 207: <insert_row> ::= _LPAREN
		 * <expression_commalist_multiple_elements> _RPAREN
		 */
		case 207: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 210: <insert_row_commalist> ::= <insert_row_commalist> _COMMA
		 * <insert_row>
		 */
		case 210: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 211: <insert_stmt> ::= INSERT INTO <target_table>
		 * <opt_target_column_list> VALUES <insert_row_commalist>
		 */
		case 211: {
		...
		/*
		 * Rule 212: <insert_stmt> ::= INSERT INTO <target_table>
		 * <opt_target_column_list> <query_exp_root>
		 */
		case 212: {
		...
		/*
		 * Rule 213: <intervaltest> ::= <expression> NOT BETWEEN <expression>
		 * AND <expression>
		 */
		case 213: {
			if (checkStmtOnly) {
			...
			break;
		/*
		 * Rule 214: <intervaltest> ::= <expression> BETWEEN <expression> AND
		 * <expression>
		 */
		case 214: {
			if (checkStmtOnly) {
			...
			break;
		/*
		 * Rule 217: <liketest> ::= <expression> NOT LIKE <expression>
		 * <opt_escape>
		 */
		case 217: {
			if (checkStmtOnly) {
		...
		case 218: {
			...
			break;
		/*
		 * Rule 219: <merge statement> ::= MERGE INTO <merge target table> USING
		 * <merge source table> ON <merge on condition> <merge operation
		 * specification list>
		 */
		case 219: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 223: <merge operation specification list> ::= <merge when
		 * clause>
		 */
		case 223: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 224: <merge operation specification list> ::= <merge operation
		 * specification list> <merge when clause>
		 */
		case 224: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 227: <merge when matched clause> ::= WHEN MATCHED THEN <merge
		...
		/*
		 * Rule 228: <merge when not matched clause> ::= WHEN NOT MATCHED THEN
		...
		/*
		 * Rule 229: <merge update specification> ::= UPDATE SET
		...
		/*
		 * Rule 230: <merge insert specification> ::= INSERT
		 * <opt_target_column_list> VALUES <insert_row>
		 */
		case 230: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 252: <opt_column_name_list> ::= _LPAREN <column_name_list>
		 * _RPAREN
		 */
		case 252: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 263: <opt_group_by_clause> ::= GROUP BY
		 * <super_groups_element_list> WITH CUBE
		 */
		case 263: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 264: <opt_group_by_clause> ::= GROUP BY
		 * <super_groups_element_list> WITH ROLLUP
		 */
		case 264: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 278: <opt_order_by_clause> ::= ORDER BY
		...
		/*
		 * Rule 284: <opt_target_column_list> ::= _LPAREN <target_column_list>
		 * _RPAREN
		 */
		case 284: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 292: <ordering_spec> ::= <expression> <opt_asc_desc>
		 * <opt_null_order>
		 */
		case 292: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 294: <ordering_spec_commalist> ::= <ordering_spec_commalist>
		 * _COMMA <ordering_spec>
		 */
		case 294: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 302: <query_combined> ::= <query_exp> <query_combined_operator>
		 * <query_term> <opt_order_by_clause> <opt_fetch_first_clause>
		 */
		case 302: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 312: <query_stmt> ::= <query_exp_root> <opt_order_by_clause>
		...
		/*
		 * Rule 315: <query_term> ::= _LPAREN <query_exp> _RPAREN
		 * <opt_order_by_clause> <opt_fetch_first_clause>
		 */
		case 315: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 316: <query_values> ::= VALUES <values_row_commalist>
		 * <opt_order_by_clause> <opt_fetch_first_clause>
		 */
		case 316: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 325: <row_comparison> ::= <value_expr_row> <relop>
		 * <value_expr_row>
		 */
		case 325: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 328: <scalar_comparison> ::= <expression> <relop> <expression>
		 */
		case 328: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 330: <schema_qualified_name> ::= <identifier>
		 */
		case 330: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 331: <schema_qualified_name> ::= <schema> _DOT <identifier>
		 */
		case 331: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 333: <selection> ::= <selection> _COMMA <project>
		 */
		case 333: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 342: <special_register> ::= CURRENT_DATE
		 */
		case 342: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 343: <special_register> ::= CURRENT_TIME
		 */
		case 343: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 344: <special_register> ::= CURRENT_TIMESTAMP
		 */
		case 344: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 345: <special_register> ::= CURRENT_TIMESTAMP _LPAREN <timestamp
		 * precision> _RPAREN
		 */
		case 345: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 346: <special_register> ::= LOCALTIME
		 */
		case 346: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 347: <special_register> ::= LOCALTIME _LPAREN <time precision>
		 * _RPAREN
		 */
		case 347: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 348: <special_register> ::= LOCALTIMESTAMP
		 */
		case 348: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 349: <special_register> ::= LOCALTIMESTAMP _LPAREN <timestamp
		 * precision> _RPAREN
		 */
		case 349: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 350: <special_register> ::= CURRENT_DEFAULT_TRANSFORM_GROUP
		 */
		case 350: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 351: <special_register> ::= CURRENT_PATH
		 */
		case 351: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 352: <special_register> ::= CURRENT_ROLE
		 */
		case 352: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 353: <special_register> ::= CURRENT_TRANSFORM_GROUP_FOR_TYPE
		...
		/*
		 * Rule 354: <special_register> ::= CURRENT_USER
		 */
		case 354: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 355: <special_register> ::= SESSION_USER
		 */
		case 355: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 356: <special_register> ::= SYSTEM_USER
		 */
		case 356: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 357: <special_register> ::= USER
		 */
		case 357: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 358: <special_register> ::= VALUE
		 */
		case 358: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 359: <subquery> ::= _LPAREN <query_exp_root> _RPAREN
		 */
		case 359: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 360: <super_groups> ::= CUBE _LPAREN <super_groups_element_list>
		 * _RPAREN
		 */
		case 360: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 361: <super_groups> ::= ROLLUP _LPAREN
		 * <super_groups_element_list> _RPAREN
		 */
		case 361: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 362: <super_groups> ::= _LPAREN _RPAREN
		 */
		case 362: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 363: <super_groups_element_exp> ::= <grouping_exp>
		 */
		case 363: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 364: <super_groups_element_exp_list> ::=
		...
		/*
		 * Rule 365: <super_groups_element_exp_list> ::=
		...
		/*
		 * Rule 366: <super_groups_element> ::= _LPAREN
		 * <super_groups_element_exp_list> _RPAREN
		 */
		case 366: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 368: <super_groups_element_list> ::= <super_groups_element>
		 */
		case 368: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 369: <super_groups_element_list> ::= <super_groups_element_list>
		 * _COMMA <super_groups_element>
		 */
		case 369: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 371: <table_correlation> ::= <as_alias> <opt_column_name_list>
		 */
		case 371: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 372: <table_func> ::= TABLE _LPAREN <opt_schema_dot>
		 * <identifier> _LPAREN <opt_expression_commalist> _RPAREN _RPAREN
		 * <table_correlation>
		 */
		case 372: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 373: <table_join> ::= <table_ref> <opt_join_type> JOIN
		 * <table_ref> ON <condition>
		 */
		case 373: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 374: <table_nested> ::= _LPAREN <table_ref> _RPAREN
		 */
		case 374: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 375: <table_qualified> ::= <schema> _DOT <table>
		...
		/*
		 * Rule 376: <table_query> ::= _LPAREN <query_exp> _RPAREN
		 * <table_correlation>
		 */
		case 376: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 377: <table_query> ::= TABLE _LPAREN <query_exp> _RPAREN
		 * <table_correlation>
		 */
		case 377: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 384: <table_ref_commalist> ::= <table_ref>
		 */
		case 384: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 385: <table_ref_commalist> ::= <table_ref_commalist> _COMMA
		 * <table_ref>
		 */
		case 385: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 386: <table_simple> ::= <table> <opt_table_correlation>
		 */
		case 386: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 387: <target_column_list> ::= <column_ref>
		 */
		case 387: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 388: <target_column_list> ::= <target_column_list> _COMMA
		 * <column_ref>
		 */
		case 388: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 390: <target_table> ::= <schema> _DOT <table>
		 */
		case 390: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 391: <time precision> ::= UNSIGNED_INTEGER
		 */
		case 391: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 392: <timestamp precision> ::= UNSIGNED_INTEGER
		 */
		case 392: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 393: <updatability_expression> ::= FOR READ ONLY
		 */
		case 393: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 394: <updatability_expression> ::= FOR UPDATE
		 */
		case 394: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 395: <updatability_expression> ::= FOR UPDATE OF
		 * <column_name_list>
		 */
		case 395: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 397: <update_assignment_expression> ::= <column_ref> _EQ
		 * <expression>
		 */
		case 397: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 398: <update_assignment_expression> ::= _LPAREN
		 * <target_column_list> _RPAREN _EQ _LPAREN <query_exp> _RPAREN
		 */
		case 398: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 399: <update_assignment_expression> ::= _LPAREN
		 * <target_column_list> _RPAREN _EQ _LPAREN <expression_commalist>
		 * _RPAREN
		 */
		case 399: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 400: <update_assignment_expression_commalist> ::=
		...
		/*
		 * Rule 401: <update_assignment_expression_commalist> ::=
		 * <update_assignment_expression_commalist> _COMMA
		 * <update_assignment_expression>
		 */
		case 401: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 402: <update_stmt> ::= UPDATE <target_table>
		 * <opt_as_target_table> SET <update_assignment_clause>
		 * <opt_where_clause>
		 */
		case 402: {
		...
		/*
		 * Rule 403: <value_expr_row> ::= _LPAREN
		 * <expression_commalist_multiple_elements> _RPAREN
		 */
		case 403: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 404: <values_row> ::= _LPAREN <expression_commalist> _RPAREN
		 */
		case 404: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 405: <values_row> ::= <expression>
		 */
		case 405: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 406: <values_row_commalist> ::= <values_row>
		 */
		case 406: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 407: <values_row_commalist> ::= <values_row_commalist> _COMMA
		 * <values_row>
		 */
		case 407: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 408: <with_clause> ::= WITH <with_table_spec_list>
		 */
		case 408: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 410: <with_table_spec_list> ::= <with_table_spec>
		 */
		case 410: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 411: <with_table_spec_list> ::= <with_table_spec_list> _COMMA
		 * <with_table_spec>
		 */
		case 411: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 412: <with_table_spec> ::= <table> <opt_column_name_list> AS
		 * _LPAREN <query_exp> _RPAREN
		 */
		case 412: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 413: <query_select> ::= SELECT <opt_all_distinct> <selection>
		 * <opt_into_clause> FROM <table_ref_commalist> <opt_where_clause>
		 * <opt_group_by_clause> <opt_having_clause> <opt_order_by_clause>
		 * <opt_fetch_first_clause> <opt_optimize_clause>
		 */
		case 413: {
			if (checkStmtOnly) {
				setSym1(null);
			...
			setSym1(m_factory.createQExtendedQuerySelect(getString(2), getList(3), getList(4), getList(6), (QuerySearchCondition) getSym(7), getList(8), (QuerySearchCondition) getSym(9),
					getList(10), getInt(11), getInt(12)));
		}
			break;

		/*
		 * Rule 415: <opt_into_clause> ::= $Empty
		 */
		case 415: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 416: <into_clause> ::= INTO <into_list>
		 */
		case 416: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		case 417: {
			...
			setSym1(m_factory.createIntoClause(null, (ValueExpressionVariable) getSym(1)));
		}
			break;

		/*
		 * Rule 418: <into_list> ::= <into_list> _COMMA <into_item>
		 */
		case 418: {
			if (checkStmtOnly) {
				setSym1(null);
			...
			setSym1(m_factory.createIntoClause(getList(1), (ValueExpressionVariable) getSym(3)));
		}
			break;

		/*
		 * Rule 420: <into_item> ::= _HOSTVAR
		 */
		case 420: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 422: <opt_optimize_clause> ::= $Empty
		 */
		case 422: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 423: <optimize_clause> ::= OPTIMIZE FOR <opt_optimize_row_count>
		 * <row_or_rows>
		 */
		case 423: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 424: <opt_optimize_row_count> ::= <unsigned_integer>
		 */
		case 424: {
			if (checkStmtOnly) {
				setSym1(null);
			...
			break;
		/*
		 * Rule 425: <opt_optimize_row_count> ::= $Empty
		 */
		case 425: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 426: <table_qualified> ::= <schema> _DOT <table>
		 * <opt_table_correlation>
		 */
		case 426: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 427: <table_qualified> ::= <schema> _SLASH <table>
		 * <opt_table_correlation>
		 */
		case 427: {
			if (checkStmtOnly) {
		...
		/*
		 * Rule 428: <project> ::= <expression> <opt_as_alias>
		 */
		case 428: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 430: <project> ::= <table> _DOT _STAR
		 */
		case 430: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 431: <project> ::= <table> _SLASH _STAR
		 */
		case 431: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 432: <project> ::= <schema> _DOT <table> _DOT _STAR
		 */
		case 432: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 433: <project> ::= <schema> _SLASH <table> _SLASH _STAR
		 */
		case 433: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 435: <target_table> ::= <schema> _DOT <table>
		 */
		case 435: {
			if (checkStmtOnly) {
				setSym1(null);
		...
		/*
		 * Rule 436: <target_table> ::= <schema> _SLASH <table>
		 */
		case 436: {
			if (checkStmtOnly) {
				setSym1(null);

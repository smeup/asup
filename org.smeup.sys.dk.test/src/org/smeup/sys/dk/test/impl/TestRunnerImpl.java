...
public abstract class TestRunnerImpl extends EObjectImpl implements QTestRunner {
	 ...
	 * @ordered
	 */
	protected EList<QTestListener> listeners;
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	public List<QTestListener> getListeners() {
		if (listeners == null) {
			listeners = new EObjectContainmentEList<QTestListener>(QTestListener.class, this, QDevelopmentKitTestPackage.TEST_RUNNER__LISTENERS);
		}
		return listeners;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case QDevelopmentKitTestPackage.TEST_RUNNER__LISTENERS:
				getListeners().clear();
				getListeners().addAll((Collection<? extends QTestListener>)newValue);
				return;
		}

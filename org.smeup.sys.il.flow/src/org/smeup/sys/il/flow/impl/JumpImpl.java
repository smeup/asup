 ...
 * @generated
 */
public class JumpImpl extends StatementImpl implements QJump {
	/**
	 *
	 */
	...
	protected EClass eStaticClass() {
		return QIntegratedLanguageFlowPackage.Literals.JUMP;
	}
	...
	public void setLabel(String newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageFlowPackage.JUMP__LABEL, oldLabel, label));
	}

 ...
 * @generated
 */
public class ReturnImpl extends StatementImpl implements QReturn {
	/**
	...
	protected EClass eStaticClass() {
		return QIntegratedLanguageFlowPackage.Literals.RETURN;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageFlowPackage.RETURN__VALUE, oldValue, value));
	}

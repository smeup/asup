...
public enum PassingType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final PassingType[] VALUES_ARRAY = new PassingType[] {
			BY_NAME,
			BY_REFERENCE,
			BY_VALUE,
		};
	...
	/**
	 * A public read-only list of all the '<em><b>Passing Type</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	...
	public static PassingType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			PassingType result = VALUES_ARRAY[i];

 ...
 * <em><b>QCommand Status</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.smeup.sys.os.cmd.QOperatingSystemCommandPackage#getCommandStatus()
 * @model
 * @generated
 */
public enum CommandStatus implements Enumerator {
	 ...
	 * @generated
	 */
	private static final CommandStatus[] VALUES_ARRAY = new CommandStatus[] {
			POSSIBLE,
			SUPPORTED,
			UNSUPPORTED,
			TODO,

 ...
 * <em><b>Command Parameter Order</b></em>', and utility methods for working
 * with them. <!-- end-user-doc -->
 * @see org.smeup.sys.os.cmd.QOperatingSystemCommandPackage#getCommandParameterOrder()
 * @model
 * @generated
 */
public enum CommandParameterOrder implements Enumerator {
	 ...
	 * @generated
	 */
	private static final CommandParameterOrder[] VALUES_ARRAY = new CommandParameterOrder[] {
			NAME,
			POSITION,
		};

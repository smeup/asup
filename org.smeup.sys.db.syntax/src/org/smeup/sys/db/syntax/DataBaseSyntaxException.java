...
public class DataBaseSyntaxException extends Exception {
	...
	public DataBaseSyntaxException(Throwable cause) {
		this(cause.getMessage(), cause.getCause());
	}

	public DataBaseSyntaxException(String message) {
		this(message, null);
	}

	public DataBaseSyntaxException(String message, Throwable cause) {
		super(message, cause);
	}
}

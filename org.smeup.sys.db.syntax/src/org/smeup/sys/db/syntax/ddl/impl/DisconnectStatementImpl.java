 ...
 * <ul>
 *   <li>{@link org.smeup.sys.db.syntax.ddl.impl.DisconnectStatementImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DisconnectStatementImpl extends DefinitionStatementImpl implements QDisconnectStatement {
	...
	protected EClass eStaticClass() {
		return QDatabaseSyntaxDDLPackage.Literals.DISCONNECT_STATEMENT;
	}
	...
	public void setTarget(TargetItem newTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDatabaseSyntaxDDLPackage.DISCONNECT_STATEMENT__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QDatabaseSyntaxDDLPackage.DISCONNECT_STATEMENT__TARGET:
				return getTarget();
		}

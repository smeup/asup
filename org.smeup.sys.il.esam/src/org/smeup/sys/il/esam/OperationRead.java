 ...
 * <!-- end-user-doc -->
 * 
 * @see org.smeup.sys.il.esam.QIntegratedLanguageEsamPackage#getOperationRead()
 * @model
 * @generated
 */
public enum OperationRead implements Enumerator {
	...
	/**
	 * The '<em><b>Read Equal</b></em>' literal object. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * The '<em><b>Read Prior</b></em>' literal object. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * The '<em><b>Read Equal</b></em>' literal value. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * The '<em><b>Read Prior</b></em>' literal value. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * The '<em><b>Read Prior Equal</b></em>' literal value. <!-- begin-user-doc
	 * -->
	 * <p>
	 ...
	 * @generated
	 */
	private static final OperationRead[] VALUES_ARRAY = new OperationRead[] { CHAIN, READ, READ_EQUAL, READ_PRIOR, READ_PRIOR_EQUAL, };

	/**
	 * A public read-only list of all the '<em><b>Operation Read</b></em>'
	...
	/**
	 * Returns the '<em><b>Operation Read</b></em>' literal with the specified
	 * literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public static OperationRead get(String literal) {
		for (OperationRead result : VALUES_ARRAY) {
	...
	public static OperationRead get(int value) {
		...
		case READ_VALUE:
			return READ;
		case READ_EQUAL_VALUE:
			return READ_EQUAL;
		case READ_PRIOR_VALUE:
			return READ_PRIOR;
		case READ_PRIOR_EQUAL_VALUE:
			return READ_PRIOR_EQUAL;
		}
		return null;
	}

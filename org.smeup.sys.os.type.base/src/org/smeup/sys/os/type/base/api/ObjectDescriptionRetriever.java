...
public class ObjectDescriptionRetriever {
	...
	public @Entry void main(@ToDo @DataDef(qualified = true) Object object, @ToDo @DataDef(length = 7) QEnum<ObjectTypeEnum, QCharacter> objectType, @ToDo ASPDevice aSPDevice,
			@ToDo @DataDef(length = 10) QCharacter cLVarForRTNLIB10, @ToDo @DataDef(length = 10) QCharacter cLVarForOBJATR10, @ToDo @DataDef(length = 10) QCharacter cLVarForUSRDFNATR10,
			@ToDo @DataDef(length = 50) QCharacter cLVarForTEXT50, @ToDo @DataDef(length = 10) QCharacter cLVarForOWNER10, @ToDo @DataDef(length = 10) QCharacter cLVarForPGP10,
			@ToDo @DataDef(precision = 2) QDecimal cLVarForASP20, @ToDo @DataDef(precision = 5) QDecimal cLVarForLIBASP50, @ToDo @DataDef(length = 10) QCharacter cLVarForOBJASPDEV10,
			@ToDo @DataDef(length = 10) QCharacter cLVarForOBJASPGRP10, @ToDo @DataDef(length = 10) QCharacter cLVarForLIBASPDEV10, @ToDo @DataDef(length = 10) QCharacter cLVarForLIBASPGRP10,
			@ToDo @DataDef(length = 1) QCharacter cLVarForOVFASP1, @ToDo @DataDef(length = 13) QCharacter cLVarForCRTDATE13, @ToDo @DataDef(length = 13) QCharacter cLVarForCHGDATE13,

...
public class ObjectDeallocator {
	...
	public @Entry void main(@ToDo @DataDef(dimension = 50) QStroller<ObjectSpecification> objectSpecifications, @ToDo @DataDef(length = 1) QEnum<LockScopeEnum, QCharacter> lockScope) {
	}

 ...
 * <ul>
 * <li>{@link org.smeup.sys.il.expr.QAssignmentExpression#getLeftOperand <em>
 * Left Operand</em>}</li>
 * <li>{@link org.smeup.sys.il.expr.QAssignmentExpression#getOperator <em>
 * Operator</em>}</li>
 * <li>{@link org.smeup.sys.il.expr.QAssignmentExpression#getRightOperand <em>
 * Right Operand</em>}</li>
 * </ul>
 * </p>
 *
...
public interface QAssignmentExpression extends QExpression {
	 ...
	 * {@link org.smeup.sys.il.expr.AssignmentOperator}. <!-- begin-user-doc -->
	 * <p>

 ...
 * <!-- end-user-doc -->
 * 
 * @see org.smeup.sys.il.expr.QIntegratedLanguageExpressionPackage#getLogicalOperator()
 * @model
 * @generated
 */
public enum LogicalOperator implements Enumerator {
	 ...
	 * @generated
	 */
	private static final LogicalOperator[] VALUES_ARRAY = new LogicalOperator[] { AND, OR, NOT, };

	/**
	 * A public read-only list of all the '<em><b>Logical Operator</b></em>'
	...
	/**
	 * Returns the '<em><b>Logical Operator</b></em>' literal with the specified

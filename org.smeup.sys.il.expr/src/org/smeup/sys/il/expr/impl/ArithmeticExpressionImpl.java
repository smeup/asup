 ...
 * <ul>
 * <li>
 * {@link org.smeup.sys.il.expr.impl.ArithmeticExpressionImpl#getLeftOperand
 * <em>Left Operand</em>}</li>
 * <li>{@link org.smeup.sys.il.expr.impl.ArithmeticExpressionImpl#getOperator
 * <em>Operator</em>}</li>
 * <li>
 * {@link org.smeup.sys.il.expr.impl.ArithmeticExpressionImpl#getRightOperand
...
public class ArithmeticExpressionImpl extends ExpressionImpl implements QArithmeticExpression {
	...
	public NotificationChain basicSetRightOperand(QExpression newRightOperand, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QIntegratedLanguageExpressionPackage.ARITHMETIC_EXPRESSION__RIGHT_OPERAND, oldRightOperand,
					newRightOperand);
			if (msgs == null)
				msgs = notification;
			else

 ...
 * <ul>
 *   <li>{@link org.smeup.sys.il.memo.cdo.store.impl.CDOStoreConfigImpl#getAdapter <em>Adapter</em>}</li>
 *   <li>{@link org.smeup.sys.il.memo.cdo.store.impl.CDOStoreConfigImpl#getCredentials <em>Credentials</em>}</li>
 *   <li>{@link org.smeup.sys.il.memo.cdo.store.impl.CDOStoreConfigImpl#getDriver <em>Driver</em>}</li>
 *   <li>{@link org.smeup.sys.il.memo.cdo.store.impl.CDOStoreConfigImpl#getRepository <em>Repository</em>}</li>
 *   <li>{@link org.smeup.sys.il.memo.cdo.store.impl.CDOStoreConfigImpl#getSocketConfig <em>Socket Config</em>}</li>
 *   <li>{@link org.smeup.sys.il.memo.cdo.store.impl.CDOStoreConfigImpl#getUrl <em>Url</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CDOStoreConfigImpl extends ObjectImpl implements CDOStoreConfig {
	...
	protected EClass eStaticClass() {
		return CDOStorePackage.Literals.CDO_STORE_CONFIG;
	}
	...
	public void setAdapter(String newAdapter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDOStorePackage.CDO_STORE_CONFIG__ADAPTER, oldAdapter, adapter));
	}
	...
	public NotificationChain basicSetCredentials(QConnectionCredentials newCredentials, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CDOStorePackage.CDO_STORE_CONFIG__CREDENTIALS, oldCredentials, newCredentials);
	...
	public void setCredentials(QConnectionCredentials newCredentials) {
		if (newCredentials != credentials) {
			...
			if (credentials != null)
				msgs = ((InternalEObject)credentials).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CDOStorePackage.CDO_STORE_CONFIG__CREDENTIALS, null, msgs);
			if (newCredentials != null)
				msgs = ((InternalEObject)newCredentials).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CDOStorePackage.CDO_STORE_CONFIG__CREDENTIALS, null, msgs);
			msgs = basicSetCredentials(newCredentials, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDOStorePackage.CDO_STORE_CONFIG__CREDENTIALS, newCredentials, newCredentials));
	}
	...
	public void setDriver(String newDriver) {
		...
		driver = newDriver;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDOStorePackage.CDO_STORE_CONFIG__DRIVER, oldDriver, driver));
	}
	...
	public void setRepository(String newRepository) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDOStorePackage.CDO_STORE_CONFIG__REPOSITORY, oldRepository, repository));
	}
	...
	public NotificationChain basicSetSocketConfig(QServerSocketConfig newSocketConfig, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CDOStorePackage.CDO_STORE_CONFIG__SOCKET_CONFIG, oldSocketConfig, newSocketConfig);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSocketConfig(QServerSocketConfig newSocketConfig) {
		if (newSocketConfig != socketConfig) {
			...
			if (socketConfig != null)
				msgs = ((InternalEObject)socketConfig).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CDOStorePackage.CDO_STORE_CONFIG__SOCKET_CONFIG, null, msgs);
			if (newSocketConfig != null)
				msgs = ((InternalEObject)newSocketConfig).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CDOStorePackage.CDO_STORE_CONFIG__SOCKET_CONFIG, null, msgs);
			msgs = basicSetSocketConfig(newSocketConfig, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDOStorePackage.CDO_STORE_CONFIG__SOCKET_CONFIG, newSocketConfig, newSocketConfig));
	}
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDOStorePackage.CDO_STORE_CONFIG__URL, oldUrl, url));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CDOStorePackage.CDO_STORE_CONFIG__CREDENTIALS:
				return basicSetCredentials(null, msgs);
			case CDOStorePackage.CDO_STORE_CONFIG__SOCKET_CONFIG:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CDOStorePackage.CDO_STORE_CONFIG__ADAPTER:
				return getAdapter();
			case CDOStorePackage.CDO_STORE_CONFIG__CREDENTIALS:
				return getCredentials();
			case CDOStorePackage.CDO_STORE_CONFIG__DRIVER:
				return getDriver();
			case CDOStorePackage.CDO_STORE_CONFIG__REPOSITORY:
				return getRepository();
			case CDOStorePackage.CDO_STORE_CONFIG__SOCKET_CONFIG:
				return getSocketConfig();
			case CDOStorePackage.CDO_STORE_CONFIG__URL:
				return getUrl();
		}

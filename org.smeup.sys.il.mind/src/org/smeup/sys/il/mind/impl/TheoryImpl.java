 ...
 * @generated
 */
public class TheoryImpl extends ObjectNameableImpl implements QTheory {
	/**
	 * 
	 */
	 ...
	 * @ordered
	 */
	protected EList<QMindTerm> facts;
	...
	protected EClass eStaticClass() {
		return QIntegratedLanguageMindPackage.Literals.THEORY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QIntegratedLanguageMindPackage.THEORY__NAME, oldName, name));
	}
	 ...
	 * @generated
	 */
	public List<QMindTerm> getFacts() {
		if (facts == null) {
			facts = new EObjectContainmentEList<QMindTerm>(QMindTerm.class, this, QIntegratedLanguageMindPackage.THEORY__FACTS);
		}
		return facts;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QIntegratedLanguageMindPackage.THEORY__FACTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QIntegratedLanguageMindPackage.THEORY__NAME:
				return getName();
			case QIntegratedLanguageMindPackage.THEORY__FACTS:
				return getFacts();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case QIntegratedLanguageMindPackage.THEORY__FACTS:
				getFacts().clear();
				getFacts().addAll((Collection<? extends QMindTerm>)newValue);
				return;
		}

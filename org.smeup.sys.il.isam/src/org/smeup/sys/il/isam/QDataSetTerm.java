 ...
 * <ul>
 *   <li>{@link org.smeup.sys.il.isam.QDataSetTerm#getAccessMode <em>Access Mode</em>}</li>
 *   <li>{@link org.smeup.sys.il.isam.QDataSetTerm#getFormatName <em>Format Name</em>}</li>
 *   <li>{@link org.smeup.sys.il.isam.QDataSetTerm#isKeyedAccess <em>Keyed Access</em>}</li>
 *   <li>{@link org.smeup.sys.il.isam.QDataSetTerm#getPrefix <em>Prefix</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.smeup.sys.il.isam.QIntegratedLanguageIsamPackage#getDataSetTerm()
 * @model
 * @generated
 */
public interface QDataSetTerm extends QFileTerm {
	 ...
	 * {@link org.smeup.sys.il.isam.AccessMode}. <!-- begin-user-doc --> <!--
	 ...
	 * @see org.smeup.sys.il.isam.QIntegratedLanguageIsamPackage#getDataSetTerm_AccessMode()
	...
	/**
	 * Sets the value of the '{@link org.smeup.sys.il.isam.QDataSetTerm#getAccessMode <em>Access Mode</em>}' attribute.
	 ...
	 * @see org.smeup.sys.il.isam.QIntegratedLanguageIsamPackage#getDataSetTerm_FormatName()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.smeup.sys.il.isam.QDataSetTerm#getFormatName <em>Format Name</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 ...
	 * @see org.smeup.sys.il.isam.QIntegratedLanguageIsamPackage#getDataSetTerm_KeyedAccess()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.smeup.sys.il.isam.QDataSetTerm#isKeyedAccess <em>Keyed Access</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 ...
	 * @see org.smeup.sys.il.isam.QIntegratedLanguageIsamPackage#getDataSetTerm_Prefix()
	 * @model
	 * @generated
	 */
	String getPrefix();
	...
	/**
	 * Sets the value of the '{@link org.smeup.sys.il.isam.QDataSetTerm#getPrefix

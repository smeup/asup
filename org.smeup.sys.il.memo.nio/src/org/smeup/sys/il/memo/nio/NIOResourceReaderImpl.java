...
public class NIOResourceReaderImpl<T extends QObjectNameable> extends ResourceReaderImpl<T> {
	...
	public NIOResourceReaderImpl(QContextProvider contextProvider, QSourceManager sourceManager, Class<T> klass, QProject project) {
	...
	public QObjectIterator<T> find(String nameFilter) {
		...
		return new NIOObjectIteratorImpl<T>(klass, new NIOSourceIterator(klass, entries.iterator()));
	}

...
public class NIOResourceWriterImpl<T extends QObjectNameable> extends NIOResourceReaderImpl<T> implements QResourceWriter<T> {

	private static final long serialVersionUID = 1L;

	private QResource resource;
	
	public NIOResourceWriterImpl(QContextProvider contextProvider, QSourceManager sourceManager, QResource resource, Class<T> klass, QProject project) {

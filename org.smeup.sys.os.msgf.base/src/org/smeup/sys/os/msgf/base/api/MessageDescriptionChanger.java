...
public class MessageDescriptionChanger {
	...
	public @Entry void main(@Supported @DataDef(length = 7) QCharacter messageIdentifier, @Supported @DataDef(qualified = true) MessageFile messageFile,
			...
			@DataDef(dimension = 102, binaryType = BinaryType.SHORT) QEnum<DataToBeDumpedEnum, QScroller<QBinary>> dataToBeDumped, QEnum<AlertOptionsEnum, AlertOptions> alertOptions,
